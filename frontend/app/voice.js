...
export default function VoiceScreen() {
  ...
  const getStatusText = () => {
    ...
    if (status === 'speaking') return 'Respondendo... Toque para parar';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Assistente por voz</Text>
      </View>
      ...
      <View style={styles.textArea}>
        ...
        {status === 'idle' && !lastText && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Fale com sua secretária</Text>
            <Text style={styles.emptySubtext}>
              Agende compromissos, registre gastos,{'\n'}crie hábitos e muito mais!
            </Text>
          </View>
        )}
      </View>
      ...
      <View style={styles.buttonArea}>
        ...
        <View style={styles.tipsRow}>
          <View style={styles.tip}>
            ...
            <Text style={styles.tipText}>Agenda</Text>
          </View>
          <View style={styles.tip}>
            <Ionicons name="wallet-outline" size={16} color={Colors.textMuted} />
            <Text style={styles.tipText}>Finanças</Text>
          </View>
          <View style={styles.tip}>
            <Ionicons name="heart-outline" size={16} color={Colors.textMuted} />
            <Text style={styles.tipText}>Hábitos</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  buttonArea: {
    alignItems: 'center', paddingBottom: 40, paddingTop: 16, gap: 16,
  },
